...
% Terradynamics Lab
    ...
    %%%%%%%% Wavelet Parameters %%%%%%%%
    %numer of dimension of input data
    numDims = 9;
    ...
    perplexity = 32; % H is chosen to be 5
    ...
    if ~isfield(parameters,'numDims') || isempty(parameters.numDims)
        parameters.numDims = numDims;
    end
